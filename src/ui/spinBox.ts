...
import NumberDisplay, { NumberDisplayProperties } from "./components/numberdisplay";
...
export default class SpinBox extends NumberDisplay {
	...
	constructor(initialProperties?: SpinBoxProperties) { // UI.spinBox
	...
	setProperties(properties: SpinBoxProperties) {
		...
		if (typeof properties.labels != "undefined") this.labels = properties.labels;
