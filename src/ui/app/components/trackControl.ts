...
export default class TrackControl extends Element {
    ...
    constructor(x?: number, y?: number, w?: number, h?: number) { // UI.trackControl
    ...
    private triggerChangeEvent(wasSolo: boolean = false){
        EventBus.trigger(EVENT.trackStateChange,{track: this.track,  solo: this.soloButton.isActive, mute: this.muteButton.isActive, wasSolo:wasSolo});
    }
