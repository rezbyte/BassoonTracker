...
export default class Animsprite extends Element {
    ...
    constructor(x: number | undefined, y: number | undefined, w: number | undefined, h: number | undefined, baseImageName: string, frames: number) { // UI.animsprite
        w = w || 14;
        h = h || 14;
    ...
    render(internal?: boolean) {
        ...
        if (this.needsRendering){
            ...
            this.clearCanvas();
            this.ctx.drawImage(this.baseImage,this.step*this.w,0,this.w,this.h,0,0,this.w,this.h);
        }
