...
export default class Image extends Element {
    ...
    constructor(x: number | undefined, y: number | undefined, w: number | undefined, h: number | undefined, src: string) { // UI.image
        w = w || 14;
        h = h || 14;
        ...
        if (this.needsRendering){
            ...
            switch (this.scale){
                ...
                default:
                    ...
                    if (this.horizintalAlign === TextAlignment.right) marginW = this.width-this.baseImage.width;
