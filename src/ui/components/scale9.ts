...
export default class Scale9Panel extends Element {
  ...
  constructor(x: number, y: number, w: number, h: number, base: Scale9) {
    // UI.scale9Panel
    super(x, y, w, h);
    this.type = "scale9";
