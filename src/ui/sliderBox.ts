...
import { Size, type ElementRangeProperties, type ElementUndoProperties } from "./basetypes";

interface SliderBoxProperties extends ElementProperties, ElementUndoProperties, ElementRangeProperties {
	label?: string,
	value?: number,
...
export class SliderBox extends Element {
	...
	constructor(initialProperties?: SliderBoxProperties) { // UI.sliderBox
		super()
		this.type = "sliderBox";
	...
	onResize() {
		...
		if (this.vertical){
            ...
            this.slider.setPosition(Math.floor((this.width-this.sliderwidth)/2),0);
